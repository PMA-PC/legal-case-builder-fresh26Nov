    ...
    <header className="bg-gradient-to-r from-teal-600 to-teal-500 p-4 shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center px-4">
        <div className="text-2xl font-bold">
          {getEmoji('FeelingsCheckIn')} <span className="bg-gradient-to-r from-purple-400 via-pink-400 to-teal-300 text-transparent bg-clip-text">Positive Mental Action!</span>
        </div>
