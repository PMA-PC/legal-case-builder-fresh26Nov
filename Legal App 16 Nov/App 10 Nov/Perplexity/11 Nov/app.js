...
// Data stored in memory (not localStorage due to sandbox restrictions)
...
function removeEvidence(fieldId, index) {
  if (evidenceFiles[fieldId]) {
...
function clearAllData() {
  if (!confirm('⚠️ WARNING: This will delete ALL case data. This action cannot be undone. Are you sure?')) {
    return;
  }
